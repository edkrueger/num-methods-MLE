In this notebook, I compare the numerical convergence rates of Gradient Descent, Newton-Rhapson and The Method of Scoring in implementing MLE of a parameter of Weibull distributed data.
